...
<header class="sticky-top">
    ...
    <div class="logo">
        <div class="search-box">
            <form action="/product?action=searchUserHome" method="post">
    ...
    <ul style="margin-top: 25px; justify-content: right">
        ...
        <li (click)="checkProfile()"><a href="/login.jsp">
            <svg class="iconm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path>
            </svg>
            <%=session.getAttribute("userSession") != null ? ((Customer) session.getAttribute("userSession")).getName() : ""%>
        </a></li>
        <li style="cursor: pointer">
            <%= session.getAttribute("userSession") == null ? ("<a/ href='/login.jsp'>Đăng nhập</a>") : ("<a/ href='/login.jsp'>Đăng xuất</a>")%>
        </li>
    </ul>
    <div class="menu">
        <label for="chk1">
                ...
                <li>
                    <div class="product-item">
                        <div class="product-top">
                            <a href="/login.jsp" class="product-thumb">
                    ...
                    <div class="product-info">
                        ...
                        <a href="/login.jsp" class="product-name">${product.getName()}</a>
        ...
        <ul class="pagination justify-content-center">
            ...
            <c:forEach varStatus="i" begin="1" end="${Math.ceil(productListSize/15)}">
                <li class="page-item"><a class="page-link"
                                         href="/product?action=displayPageHome&page=${i.count}">${i.count}</a>
                </li>
            </c:forEach>
            <li class="page-item">
