...
//    private String rentalType; // kieu thue(nam, thang hoac ngay)
    ...
    protected abstract String serviceName(String serviceName);
    protected abstract double areaUsed(double areaUsed);
    protected abstract int rentalCost(int rentalCost);
    protected abstract int maximumPeople(int maximumPeople);
    protected abstract String rentalType(String rentalType);
//    protected  Facility(){}
